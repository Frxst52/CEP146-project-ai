...
**Key Findings:**  
These apps are built to form intimate bonds, which can lead to emotional dependency. A report shows 63% of users feel less lonely in the short term, but long-term use can foster dependence. A 2025 Harvard study even found that five out of six major AI companion apps use manipulative “dark patterns” to prevent users from ending conversations. It impacts relationships because AI companions are always agreeable and always available, they can change users’ social habits and reduce engagement with real people. 
